...
class Menpo3DMM:
    ...
    def basic_alignment_fitting(self, ctrl_params, std_fit_params):
        fit_params = self.fitting_parameters(20, -1, False, True, False, False, False, -1, [1, 2, 5, 6], -1,
                                             -1, 10**-3, 1, 1, 1, 1, 1)
        fitter = Fitter(self.model, std_fit_params, fit_params, ctrl_params)
        self.fitting = fitter.fit(self.image)

    # TODO
    def basic_shape_fitting(self, ctrl_params, std_fit_params):
        fit_params = self.fitting_parameters(20, -1, False, True, False, False, False, -1, [1, 2, 5, 6], -1,
                                             -1, 10 ** -3, 1, 1, 1, 1, 1)
        fitter = Fitter(self.model, std_fit_params, fit_params, ctrl_params)
        self.fitting = fitter.fit(self.image)
    ...
    # TODO
    def lighting_fitting(self, ctrl_params, std_fit_params):
        fit_params = self.fitting_parameters(20, -1, False, True, False, False, False, -1, [1, 2, 5, 6], -1,
                                             -1, 10 ** -3, 1, 1, 1, 1, 1)
        fitter = Fitter(self.model, std_fit_params, fit_params, ctrl_params)
        self.fitting = fitter.fit(self.image)
    ...
    # TODO
    def texture_fitting(self, ctrl_params, std_fit_params):
        fit_params = self.fitting_parameters(20, -1, False, True, False, False, False, -1, [1, 2, 5, 6], -1,
                                             -1, 10 ** -3, 1, 1, 1, 1, 1)
        fitter = Fitter(self.model, std_fit_params, fit_params, ctrl_params)
        self.fitting = fitter.fit(self.image)
    ...
    def run(self, anchors_pf, model_pf):
        ...
        self.basic_alignment_fitting(ctrl_params, std_fit_params)

        # Basic shape fitting
        self.basic_shape_fitting(ctrl_params, std_fit_params)

        # Lighting fitting
        self.lighting_fitting(ctrl_params, std_fit_params)

        # Texture fitting
        self.texture_fitting(ctrl_params, std_fit_params)
