...
if not on_rtd:
  # Add the menpo3d root so we can grab the version
  sys.path.insert(0, os.path.abspath('../../'))
...
version = menpo3d.__version__
# The full version, including alpha/beta/rc tags.
release = menpo3d.__version__
...
latex_documents = [
    ('index', 'Menpo3D.tex', u'Menpo3D Documentation',
     authors, 'manual'),
]
...
man_pages = [
    ('index', 'menpo3d', u'Menpo3D Documentation',
     [authors], 1)
]
...
texinfo_documents = [
    ('index', 'Menpo3D', u'Menpo3D Documentation',
     authors,
     'Menpo3D', 'Python framework for fitting and training deformable models.',
     'Miscellaneous'),
]
